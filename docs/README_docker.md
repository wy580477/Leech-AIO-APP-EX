...
## <a id="first"></a>First run
   ...
   3. Open log/qBittorrent/current file under docker volume diretory to get qBit temporary password. Click qBittorrent or VueTorrent, type default username admin and temporary password to login. Change default user/password to your own. Recommend strong password.
